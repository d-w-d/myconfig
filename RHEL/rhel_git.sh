...
##########################################################################################
### This file cobbles together functions and commands to improve usage of git on centos
### These scripts, commands, etc. are taken from scrounging around on debian, mac, google
...
### Simple function to determine checked-out SHA
### Other functions out there give more (too much IMO) info on the git state 
__git_ps1 ()
{
    local exit=$?;
    local pcmode=no;
